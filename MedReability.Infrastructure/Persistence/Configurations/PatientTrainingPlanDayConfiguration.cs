...
public class PatientTrainingPlanDayConfiguration : IEntityTypeConfiguration<PatientTrainingPlanDayEntity>
{
    public void Configure(EntityTypeBuilder<PatientTrainingPlanDayEntity> builder)
    {
